	...
	*/
	...
	public void setUp() throws Exception {
		...
		p = new InfrastructureProject ("Tower", "Mario",
				...
				300.0, system.getSingleDistrict("Hortaleza"), "~/Desktop/Projects/Infrastructure/picture1");

		g = new Group("Sports", u1, "For sport lovers");
		
		sg1 = new Subgroup("Tenis", u3, "Tennis lovers", 2, g);
		sg2 = new Subgroup("Roland Garros", u4, "Rafa Nadal", 3, g);
		sg3 = new Subgroup("Footbal", u3, "Football lovers", 2, g);

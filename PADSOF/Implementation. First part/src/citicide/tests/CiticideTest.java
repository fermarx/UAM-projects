...
public class CiticideTest {
	...
	public static void main(String[] args) throws Exception {
		...
		Thread.sleep(700);
		sg1 = new Subgroup("Cats", u8, "Cats is the best musical of all times", 1, g1);
		...
		Thread.sleep(700);
		sg2 = new Subgroup("Billy Elliot", u7, "We love dance", 1, g1);
		...
		Thread.sleep(700);
		sg3 = new Subgroup("Cats: The movie", u10, "Cats the movie was a complete failure", 2, g1);
		...
		Thread.sleep(700);
		sg4 = new Subgroup("Zelda", u6, "The best videogame saga of all times", 1, g2);
		...
		Thread.sleep(700);
		sg5 = new Subgroup("Zelda: breath of the wild", u9, "A masterpiece", 2, g2);

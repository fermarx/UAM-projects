...
\begin{DoxyCompactList}\small\item\em Definition of the Id as a long number. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
{\bfseries T\+R\+UE}
 \}\begin{DoxyCompactList}\small\item\em Enumeration for the use of Bool fucntion which isnt avaible in C programming unless you implement this. \end{DoxyCompactList}
\item 
...
{\bfseries OK}
 \}\begin{DoxyCompactList}\small\item\em Enumeration for the correct use of status, instead of returning 0 or 1. \end{DoxyCompactList}
\item 
...
{\bfseries E}, 
{\bfseries W}
 \}\begin{DoxyCompactList}\small\item\em Enumeration for the use of directions north, south, east and west. \end{DoxyCompactList}
\end{DoxyCompactItemize}

...
public class GetPagos extends ServletRaiz {
    ...
    */    
	...
	ArrayList<PagoBean> aux;
		...
		BindingProvider bp = (BindingProvider) dao;		bp.getRequestContext().put(BindingProvider.ENDPOINT_ADDRESS_PROPERTY, getServletContext().getInitParameter("VisaDAOWSServiceURL"));
	...
	/*PagoBean[] pagos = null
	pagos = dao.getPagos(idComercio).toArray(pagos);         */
